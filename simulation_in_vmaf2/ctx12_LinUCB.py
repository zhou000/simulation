...
# debug:
# VIDEO_VMAF_FILE = '../simulation_vmaf/BBB_ED_vmaf_1s/vmaf_'
# LOG_FILE = '../test_results/log_ctx12_LinUCB0'
...
X_INFO = 12  # throughput*3, bit_rate, buffer_size, chunk_size, penalty_sm, avg_size*5
X_D = X_INFO
X_LEN = 9
...
def main():
    ...
    while True:  # serve video forever
        ...
        if video_chunk_num > 0:
            ...
            x_context[7, -1] = avg_chunk_sizes[0] / M_IN_K / M_IN_K
            x_context[8, -1] = avg_chunk_sizes[1] / M_IN_K / M_IN_K
            x_context[9, -1] = avg_chunk_sizes[2] / M_IN_K / M_IN_K
            x_context[10, -1] = avg_chunk_sizes[3] / M_IN_K / M_IN_K
            x_context[11, -1] = avg_chunk_sizes[4] / M_IN_K / M_IN_K
        ...
        for i in range(0, A_DIM):
            ...
            # avg_chunk_size_1 = avg_chunk_sizes[1] / M_IN_K / M_IN_K   # the average of next_video_chunk_sizes
            # avg_chunk_size_2 = avg_chunk_sizes[2] / M_IN_K / M_IN_K   # the average of next_2_video_chunk_sizes
            # avg_chunk_size_3 = avg_chunk_sizes[3] / M_IN_K / M_IN_K
            # avg_chunk_size_4 = avg_chunk_sizes[4] / M_IN_K / M_IN_K
            # avg_chunk_size_5 = avg_chunk_sizes[5] / M_IN_K / M_IN_K
            # cx_i = np.array(
            #     [bitrate_i, start_buffer, video_chunk_size_i, throughput_1, throughput_2, throughput_3,
            #      penalty_sm_i, avg_chunk_size_1, avg_chunk_size_2, avg_chunk_size_3, avg_chunk_size_4, avg_chunk_size_5])
