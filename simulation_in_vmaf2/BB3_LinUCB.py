...
# # debug:
# VIDEO_VMAF_FILE = '../simulation_vmaf/BBB_ED_vmaf_1s/vmaf_'
# LOG_FILE = '../test_results/log_ctx3_LinUCB0'
...
def main():
    ...
    while True:  # serve video forever
        ...
        if video_chunk_num > 0:
            ...
            past_penalty_rb = VMAF_REBUF_PENALTY * max(0, past_download_time - (state[1, -2] * 10 )) / M_IN_K    # /1000
        ...
        for i in range(0, A_DIM):
            ...
            penalty_rb_i = VMAF_REBUF_PENALTY * max(0, download_time_i - buffer_size) / M_IN_K  # /1000
        ...
        if BB_buffer < 5.0 or rebuf > 0:
            ...
            if last_arm <= 2:
                ...
                idx = 2
        # if BB_buffer <= BUFFER_BOUND1 or rebuf > 0:
        #     idx = 0
