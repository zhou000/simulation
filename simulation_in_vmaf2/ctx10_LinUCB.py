...
REBUF_FACTOR = VMAF_REBUF_PENALTY * 10 / M_IN_K     # 100 in vmaf2
...
# # debug:
# VIDEO_VMAF_FILE = '../simulation_vmaf/BBB_ED_vmaf_1s/vmaf_'
# LOG_FILE = '../test_results/log_ctx10_LinUCB0'
...
X_INFO = 10  # throughput*5, bit_rate, buffer_size, chunk_size, penalty_sm, REBUF_FACTOR
X_D = X_INFO
X_LEN = 9
