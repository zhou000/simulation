...
# # VIDEO_VMAF_FILE = '../simulation_vmaf/BBB_ED_vmaf_1s/vmaf_'
# VIDEO_VMAF_FILE = '../simulation_vmaf/BBB_ED_vmaf_4s/vmaf_'
# LOG_FILE = '../test_results/log_ctx5_LinUCB0'
...
X_INFO = 5  # throughput*1, bit_rate, buffer_size, chunk_size, penalty_sm
X_D = X_INFO
X_LEN = 8
...
def main():
    ...
    while True:  # serve video forever
        ...
        if video_chunk_num > 0:
            ...
            x_context[4, -1] = state[4, -1]  # sm penalty
        ...
        for i in range(0, A_DIM):
            ...
            cx_i = np.array(
                [video_quality_i, start_buffer, video_chunk_size_i, throughput_1, penalty_sm_i])
