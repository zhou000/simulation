...
X_INFO = 14  # throughput*5, bit_rate, buffer_size, chunk_size, penalty_sm, video_quality_level*5
X_D = X_INFO
X_LEN = 9
...
def main():
    ...
    while True:  # serve video forever
        ...
        # x_context[3, -1] = state[3, -1]  # throughput    kilo byte / ms
        # x_context[4, -1] = state[3, -2]
        # x_context[5, -1] = state[3, -3]
        ...
        x_context[6, -1] = state[3, -5]
        x_context[7, -1] = state[3, -6]
        ...
        x_context[9, -1] = get_chunk_quality(video_quality_level, video_chunk_num)  # quality level for the video chunk
        x_context[10, -1] = get_chunk_quality(video_quality_level, video_chunk_num + 1)  # *** next video chunk
        x_context[11, -1] = get_chunk_quality(video_quality_level, video_chunk_num + 2)  # +2
        ...
        for i in range(0, A_DIM):
            ...
            cx_i = np.array(
                [bitrate_i, start_buffer, video_chunk_size_i, throughput_1, throughput_2, throughput_3,
                 throughput_4, throughput_5, penalty_sm_i, quality_level_1, quality_level_2, quality_level_3,
                 quality_level_4, quality_level_5])
