...
def main():
    ...
    while True:  # serve video forever
        ...
        if video_chunk_num > 0:
            ...
            x_context[7, -1] = next_video_chunk_sizes[0] / M_IN_K / M_IN_K  # M byte
            x_context[8, -1] = next_video_chunk_sizes[1] / M_IN_K / M_IN_K
            x_context[9, -1] = next_video_chunk_sizes[2] / M_IN_K / M_IN_K
            x_context[10, -1] = next_video_chunk_sizes[3] / M_IN_K / M_IN_K
            x_context[11, -1] = next_video_chunk_sizes[4] / M_IN_K / M_IN_K
            x_context[12, -1] = next_video_chunk_sizes[5] / M_IN_K / M_IN_K
