...
def main():
    ...
    while True:  # serve video forever
        ...
        if video_chunk_num % COARSE_DIM == 0:
            ...
            # adaptive alpha according to the number of rounds
            if video_chunk_num / TOTAL_VIDEO_CHUNKS < 0.3:
                adaptive_alpha = 1
            # elif video_chunk_num < 500:
            #     adaptive_alpha = 1
            else:
            ...
            # if video_chunk_num / TOTAL_VIDEO_CHUNKS >= 0.1:  # adaptive_alpha = 1 for the first 10% decisions
            #     if buffer_size < 10:
            #         adaptive_alpha = 0.1
            #     elif buffer_size < 30:
            #         adaptive_alpha = 1
            ...
            for i in range(0, A_DIM):
                ...
                video_chunk_size = np.zeros(COARSE_DIM)
                ...
                for j in range(COARSE_DIM):
                    ...
                    video_chunk_size[j] = get_chunk_size(i, video_chunk_num + 1 + j) / M_IN_K / M_IN_K   # M byte
                    if j > 0:
                ...
                #      throughput_4, throughput_5, video_quality_1, video_chunk_size_1])
                ...
                # cx_i = np.array(
                #     [video_quality_last_chunk, start_buffer, throughput_1, throughput_2, throughput_3, throughput_4,
                #      throughput_5, video_quality_1, video_quality_2, video_quality_3, video_quality_4,
                #      video_chunk_size_1, video_chunk_size_2, video_chunk_size_3, video_chunk_size_4])
